...
// const imagesGalleryEl = images.map(element => {
//   const addGalleryListElImg = 
...
// galleryEl.insertAdjacentHTML("beforeend", imagesGalleryEl.join(' '));



const galleryEl = document.querySelector('.gallery');

const imagesGalleryEl = images.map(elemnt => {
  const itemEl = document.createElement('li');

  const imgEl = document.createElement('img');
  imgEl.src = elemnt.url;
  imgEl.alt = elemnt.alt;
  imgEl.width = 320;
  imgEl.height = 200;
 ...
 return itemEl.appendChild(imgEl);
